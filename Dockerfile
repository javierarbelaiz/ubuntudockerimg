...
RUN REPOLIST=rhel-7-server-rpms,rhel-8-server-optional-rpms \
### Add your package needs here
    INSTALL_PKGS="golang-github-cpuguy83-go-md2man" && \
    yum -y update-minimal --disablerepo "*" --enablerepo rhel-7-server-rpms/7Server/x86_64 --setopt=tsflags=nodocs \
